...
\setmintedinline{
    style=colorful, % 设置代码风格，可选的代码风格参考：https://pygments.org/styles/
    fontsize=\footnotesize, % 设置代码字体大小
    breakanywhere, % 允许行内代码在任意位置断行（兼容更多 TeXLive/minted 版本）
...
% 正文：小四（zihao=-4 已在 documentclass 设置），宋体；英文/数字 Times New Roman
\IfFontExistsTF{Times New Roman}{\setmainfont{Times New Roman}}{\setmainfont{TeX Gyre Termes}}

% 一级/二级/三级标题
\ctexset{
    section = {format=\zihao{3}\heiti\bfseries},
...
% 图题/表题：小五宋体，居中；图在下、表在上（表题位置仍建议放在 tabular 之前）
\DeclareCaptionFont{captionxiaowu}{\zihao{-5}\songti}
\captionsetup{
    font=captionxiaowu,
    labelfont=captionxiaowu,
    labelsep=space,
...
% “图 1-1 / 表 1-1 …” 形式（在 ctexart 下按 section 编号）
